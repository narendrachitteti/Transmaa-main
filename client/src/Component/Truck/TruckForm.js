...
import Navbar from '../Truck/Navbar'
...
const TruckForm = () => {
  ...
  const fetchTruckServices = async () => {
    try {
      // console.log("Fetching Truck Services"); // Check if this log is printed
  ...
  const generateWhatsappMessage = (service) => {
    return `
      Truck Driver Name: ${service.prefix}${service.truckdrivername}
        ...
        <table className="lab-service-table_5">
          <thead>
            <tr className="product-ooi">
              ...
              <th className="product-ooi">Vehicle No</th>
