const User= require("../models/DeletedUserModel.js");
const Userdel = require("../models/RegisterModel.js");
...
exports.resdeleteUserDetail = async (req, res) => {
    const UserId = req.params.id;
...
function sendLoginEmail(username, fullName, userType) {
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "chittetinarendra@gmail.com", // Your Gmail email address
      pass: "opmo mcdm clmp eitg", // Your Gmail password
    },
  });
  ...
  const mailOptions = {
    from: "chittetinarendra@gmail.com",
    to: "matricalfullstack@gmail.com", // Recipient email address
